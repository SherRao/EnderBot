...
public class ResumeCommand extends ChatCommandProcessor {
	
	protected AudioIO player;

	public ResumeCommand( Client client, String command, Permission permission, String usage, String... aliases ) {
